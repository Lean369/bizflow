...
{
    [Serializable]
    public partial class PropertiesCoinDispenserState
    {
        ...
        public StateEvent OnTakeCoins;
        private string HostNameField;
        [XmlElement()]
        public StateEvent OnPrintTicketOnReceiptPrinter;

        public PropertiesCoinDispenserState()
        {
            ...
            this.moreTimeField.MaxTimeOut = 15;
            this.HostNameField = "RedpagosMulesoftHost";
            this.OnShowScreen = new StateEvent(StateEvent.EventType.navigate, "coinDispense.htm", "");
            this.OnPleaseWait = new StateEvent(StateEvent.EventType.runScript, "ShowPleaseWait", "");
            this.OnTakeCoins = new StateEvent(StateEvent.EventType.runScript, "TakeCoins", "");
            this.OnPrintTicketOnReceiptPrinter = new StateEvent(StateEvent.EventType.printJournalAndReceipt, "Pr1PaymentCompletedTicket1", "");
        }
